...
import org.eviline.core.ss.AngelBag7NShapeSource;
...
public class Angeline2Randomizer extends Randomizer {
...
//			});
	...
	protected AngelBag7NShapeSource shapes;
	
	protected int count;
	protected int current;
	
	public Angeline2Randomizer() {
	}

	public Angeline2Randomizer(boolean[] pieceEnable, long seed) {
...
//		ai.setAdjuster(ADJUSTER);
		shapes = new AngelBag7NShapeSource(DEFAULT_BAG_N, DEFAULT_LOOKAHEAD);
		shapes.setAi(ai);
